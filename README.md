...
* [Original Gaussian Splatting](https://github.com/graphdeco-inria/gaussian-splatting) ⭐ 23,685 | 🐛 713 | 🌐 Python | 📅 2025-10-17 - The reference implementation by the original authors

### Community Implementations

| Implementation                                                                                                                                        | Language       | License    | Description                                                                                                                                                                 |
| ----------------------------------------------------------------------------------------------------------------------------------------------------- | -------------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [LichtFeld Studio](https://github.com/MrNeRF/LichtFeld-Studio) ⭐ 3,636 \| 🐛 204 \| 🌐 C++ \| 📅 2026-08-31 ([lichtfeld.io](https://lichtfeld.io))    | C++/CUDA       | GPL-3.0    | The modular workstation for 3D Gaussian Splatting — train, inspect, edit, automate, and export from a single native app                                                     |
| [Nerfstudio gsplat](https://github.com/nerfstudio-project/gsplat) ⭐ 5,611 \| 🐛 361 \| 🌐 Python \| 📅 2026-08-20                                     | Python/CUDA    | Apache-2.0 | Integration with Nerfstudio                                                                                                                                                 |
| [OpenSplat](https://github.com/pierotofy/OpenSplat) ⭐ 2,169 \| 🐛 16 \| 🌐 C++ \| 📅 2026-08-28                                                       | C++/CPU/GPU    | AGPL-3.0   | Cross-platform solution                                                                                                                                                     |
...
* [DriveStudio](https://github.com/ziyc/drivestudio) ⭐ 1,254 | 🐛 55 | 🌐 Python | 📅 2025-08-27 - Urban scene reconstruction framework
...
* [PlayCanvas Engine](https://github.com/playcanvas/engine) ⭐ 16,591 | 🐛 525 | 🌐 JavaScript | 📅 2026-08-31
* [Unity Plugin](https://github.com/aras-p/UnityGaussianSplatting) ⭐ 3,393 | 🐛 43 | 🌐 C# | 📅 2025-10-17
...
* [SuperSplat Viewer](https://github.com/playcanvas/supersplat-viewer) ⭐ 547 | 🐛 34 | 🌐 TypeScript | 📅 2026-08-27 - High-performance splat viewer
* [WebGPU Splat](https://github.com/KeKsBoTer/web-splat) ⭐ 295 | 🐛 14 | 🌐 Rust | 📅 2026-03-31
* [gaussian-splatting-webgpu](https://github.com/MarcusAndreasSvensson/gaussian-splatting-webgpu) ⭐ 91 | 🐛 7 | 🌐 TypeScript | 📅 2024-06-25

### Desktop Viewers

* [Nerfstudio Viser](https://github.com/viser-project/viser) ⭐ 2,754 | 🐛 114 | 🌐 Python | 📅 2026-08-31
...
* [3DGS.cpp](https://github.com/shg8/3DGS.cpp) ⭐ 781 | 🐛 16 | 🌐 C++ | 📅 2025-05-19 - C++/Vulkan renderer for Windows, macOS, Linux, iOS and visionOS
...
* [Blender Add-on (KIRI)](https://github.com/Kiri-Innovation/3dgs-render-blender-addon) ⭐ 1,171 | 🐛 10 | 🌐 Python | 📅 2026-08-30
...
* [SplatTransform](https://github.com/playcanvas/splat-transform) ⭐ 1,303 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-25 - CLI tool and Node/browser library for converting and editing splats, reads PLY, SOG, SPZ, SPLAT, KSPLAT and LCC/LCC2, writes PLY, SOG, SPZ, GLB, CSV, LOD and WebP
* [3DGS Converter](https://github.com/francescofugazzi/3dgsconverter) ⭐ 594 | 🐛 0 | 🌐 Python | 📅 2026-08-01 - Format conversion tool
...
* [SuperSplat](https://github.com/playcanvas/supersplat) ⭐ 9,929 | 🐛 108 | 🌐 TypeScript | 📅 2026-08-27 - Free, open source browser-based 3DGS editor with one-click publishing
...
* [LichtFeld Studio](https://www.youtube.com/@LichtFeldStudio) - Tutorials, release walkthroughs and dev updates for [LichtFeld Studio](https://github.com/MrNeRF/LichtFeld-Studio) ⭐ 3,636 | 🐛 204 | 🌐 C++ | 📅 2026-08-31
