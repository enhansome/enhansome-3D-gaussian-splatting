...
* [Original Gaussian Splatting](https://github.com/graphdeco-inria/gaussian-splatting) ⭐ 23,957 | 🐛 713 | 🌐 Python | 📅 2025-10-17 - The reference implementation by the original authors

### Community Implementations

| Implementation                                                                                                                                        | Language       | License    | Description                                                                                                                                                                 |
| ----------------------------------------------------------------------------------------------------------------------------------------------------- | -------------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [LichtFeld Studio](https://github.com/MrNeRF/LichtFeld-Studio) ⭐ 3,755 \| 🐛 212 \| 🌐 C++ \| 📅 2026-09-23 ([lichtfeld.io](https://lichtfeld.io))    | C++/CUDA       | GPL-3.0    | The modular workstation for 3D Gaussian Splatting — train, inspect, edit, automate, and export from a single native app                                                     |
| [Nerfstudio gsplat](https://github.com/nerfstudio-project/gsplat) ⭐ 5,721 \| 🐛 368 \| 🌐 Python \| 📅 2026-09-19                                     | Python/CUDA    | Apache-2.0 | Integration with Nerfstudio                                                                                                                                                 |
...
| [MetalSplat](https://github.com/tchauffi/metalsplat) ⭐ 7 \| 🐛 2 \| 🌐 Python \| 📅 2026-09-22                                                        | PyTorch/Metal  | MIT        | Metal-based implementation for Apple Silicon GPUs on PyTorch with automatic kernel compilation at runtime                                                                   |

### Frameworks

* [GauStudio](https://github.com/GAP-LAB-CUHK-SZ/gaustudio) ⭐ 1,758 | 🐛 34 | 🌐 Jupyter Notebook | 📅 2025-11-05 - Unified framework with multiple implementations
...
* [PlayCanvas Engine](https://github.com/playcanvas/engine) ⭐ 16,898 | 🐛 464 | 🌐 JavaScript | 📅 2026-09-23
...
* [Godot Plugin (gdgs)](https://github.com/ReconWorldLab/godot-gaussian-splatting) ⭐ 284 | 🐛 2 | 🌐 GDScript | 📅 2026-08-25 - Real-time 3DGS rendering plugin for Godot 4.3+
...
* [gsplat.js](https://github.com/huggingface/gsplat.js) ⭐ 1,666 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-23
...
* [SuperSplat Viewer](https://github.com/playcanvas/supersplat-viewer) ⭐ 572 | 🐛 34 | 🌐 TypeScript | 📅 2026-09-23 - High-performance splat viewer
...
* [Nerfstudio Viser](https://github.com/viser-project/viser) ⭐ 2,790 | 🐛 111 | 🌐 Python | 📅 2026-09-15
...
* [SplatTransform](https://github.com/playcanvas/splat-transform) ⭐ 1,332 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-23 - CLI tool and Node/browser library for converting and editing splats, reads PLY, SOG, SPZ, SPLAT, KSPLAT and LCC/LCC2, writes PLY, SOG, SPZ, GLB, CSV, LOD and WebP
...
* [SuperSplat](https://github.com/playcanvas/supersplat) ⭐ 10,249 | 🐛 113 | 🌐 TypeScript | 📅 2026-09-23 - Free, open source browser-based 3DGS editor with one-click publishing
...
* [LichtFeld Studio](https://www.youtube.com/@LichtFeldStudio) - Tutorials, release walkthroughs and dev updates for [LichtFeld Studio](https://github.com/MrNeRF/LichtFeld-Studio) ⭐ 3,755 | 🐛 212 | 🌐 C++ | 📅 2026-09-23
