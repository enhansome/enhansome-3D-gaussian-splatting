...
* [Original Gaussian Splatting](https://github.com/graphdeco-inria/gaussian-splatting) ⭐ 23,697 | 🐛 713 | 🌐 Python | 📅 2025-10-17 - The reference implementation by the original authors

### Community Implementations

| Implementation                                                                                                                                        | Language       | License    | Description                                                                                                                                                                 |
| ----------------------------------------------------------------------------------------------------------------------------------------------------- | -------------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [LichtFeld Studio](https://github.com/MrNeRF/LichtFeld-Studio) ⭐ 3,640 \| 🐛 204 \| 🌐 C++ \| 📅 2026-09-01 ([lichtfeld.io](https://lichtfeld.io))    | C++/CUDA       | GPL-3.0    | The modular workstation for 3D Gaussian Splatting — train, inspect, edit, automate, and export from a single native app                                                     |
| [Nerfstudio gsplat](https://github.com/nerfstudio-project/gsplat) ⭐ 5,617 \| 🐛 361 \| 🌐 Python \| 📅 2026-08-20                                     | Python/CUDA    | Apache-2.0 | Integration with Nerfstudio                                                                                                                                                 |
...
* [DriveStudio](https://github.com/ziyc/drivestudio) ⭐ 1,255 | 🐛 55 | 🌐 Python | 📅 2025-08-27 - Urban scene reconstruction framework
* [gaussian-splatting-lightning](https://github.com/yzslab/gaussian-splatting-lightning) ⭐ 1,102 | 🐛 32 | 🌐 Jupyter Notebook | 📅 2026-05-25 - Derived algorithms plus an interactive web viewer
...
* [PlayCanvas Engine](https://github.com/playcanvas/engine) ⭐ 16,599 | 🐛 518 | 🌐 JavaScript | 📅 2026-09-01
...
* [Godot Plugin (gdgs)](https://github.com/ReconWorldLab/godot-gaussian-splatting) ⭐ 275 | 🐛 2 | 🌐 GDScript | 📅 2026-08-25 - Real-time 3DGS rendering plugin for Godot 4.3+
...
* [GaussianSplats3D](https://github.com/mkkellogg/GaussianSplats3D) ⭐ 2,878 | 🐛 97 | 🌐 JavaScript | 📅 2025-10-19
* [gsplat.js](https://github.com/huggingface/gsplat.js) ⭐ 1,661 | 🐛 42 | 🌐 TypeScript | 📅 2026-05-26
* [Gauzilla](https://github.com/BladeTransformerLLC/gauzilla) ⭐ 637 | 🐛 0 | 🌐 JavaScript | 📅 2025-05-23
...
* [SuperSplat Viewer](https://github.com/playcanvas/supersplat-viewer) ⭐ 548 | 🐛 34 | 🌐 TypeScript | 📅 2026-08-27 - High-performance splat viewer
...
* [Nerfstudio Viser](https://github.com/viser-project/viser) ⭐ 2,756 | 🐛 114 | 🌐 Python | 📅 2026-08-31
...
* [Blender Add-on (KIRI)](https://github.com/Kiri-Innovation/3dgs-render-blender-addon) ⭐ 1,173 | 🐛 10 | 🌐 Python | 📅 2026-08-30
...
* [Splat Local](https://github.com/michael-L-i/splat-local) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2026-08-28 - Video-to-3DGS pipeline running fully locally on Apple Silicon (COLMAP/GLOMAP poses, Metal-native training via Brush), with training checkpoints streamed live into a browser viewer

## Tools & Utilities

### Data Processing

* [SplatTransform](https://github.com/playcanvas/splat-transform) ⭐ 1,304 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-25 - CLI tool and Node/browser library for converting and editing splats, reads PLY, SOG, SPZ, SPLAT, KSPLAT and LCC/LCC2, writes PLY, SOG, SPZ, GLB, CSV, LOD and WebP
...
* [SuperSplat](https://github.com/playcanvas/supersplat) ⭐ 9,932 | 🐛 108 | 🌐 TypeScript | 📅 2026-08-27 - Free, open source browser-based 3DGS editor with one-click publishing
* [GSOPs for Houdini](https://github.com/cgnomads/GSOPs) ⭐ 619 | 🐛 0 | 🌐 Python | 📅 2026-08-14 - Houdini integration tools
...
* [Discussion about gs universal format](https://github.com/mkkellogg/GaussianSplats3D/issues/47#issuecomment-1801360116) ⭐ 2,878 | 🐛 97 | 🌐 JavaScript | 📅 2025-10-19
...
* [LichtFeld Studio](https://www.youtube.com/@LichtFeldStudio) - Tutorials, release walkthroughs and dev updates for [LichtFeld Studio](https://github.com/MrNeRF/LichtFeld-Studio) ⭐ 3,640 | 🐛 204 | 🌐 C++ | 📅 2026-09-01
