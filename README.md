...
* [Original Gaussian Splatting](https://github.com/graphdeco-inria/gaussian-splatting) ⭐ 23,907 | 🐛 714 | 🌐 Python | 📅 2025-10-17 - The reference implementation by the original authors

### Community Implementations

| Implementation                                                                                                                                        | Language       | License    | Description                                                                                                                                                                 |
| ----------------------------------------------------------------------------------------------------------------------------------------------------- | -------------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [LichtFeld Studio](https://github.com/MrNeRF/LichtFeld-Studio) ⭐ 3,711 \| 🐛 222 \| 🌐 C++ \| 📅 2026-09-18 ([lichtfeld.io](https://lichtfeld.io))    | C++/CUDA       | GPL-3.0    | The modular workstation for 3D Gaussian Splatting — train, inspect, edit, automate, and export from a single native app                                                     |
| [Nerfstudio gsplat](https://github.com/nerfstudio-project/gsplat) ⭐ 5,697 \| 🐛 370 \| 🌐 Python \| 📅 2026-09-03                                     | Python/CUDA    | Apache-2.0 | Integration with Nerfstudio                                                                                                                                                 |
| [OpenSplat](https://github.com/pierotofy/OpenSplat) ⭐ 2,189 \| 🐛 13 \| 🌐 C++ \| 📅 2026-09-16                                                       | C++/CPU/GPU    | AGPL-3.0   | Cross-platform solution                                                                                                                                                     |
...
| [Grendel Distributed 3DGS](https://github.com/nyu-systems/Grendel-GS) ⭐ 684 \| 🐛 36 \| 🌐 Python \| 📅 2025-09-24                                    | Python/CUDA    | Apache-2.0 | Multi-GPU distributed training                                                                                                                                              |
...
| [3D-Gaussian-Splatting-Reconstruction](https://github.com/Chi-Blaze-B/3D-Gaussian-Splatting-Reconstruction) ⭐ 1 \| 🐛 0 \| 🌐 Python \| 📅 2026-09-15 | Python         | Apache-2.0 | Pure PyTorch implementation from video input — no CUDA compilation required, supports CPU/NVIDIA GPU backends, built-in pose estimator & GUI                                |
| [MetalSplat](https://github.com/tchauffi/metalsplat) ⭐ 7 \| 🐛 3 \| 🌐 Python \| 📅 2026-09-17                                                        | PyTorch/Metal  | MIT        | Metal-based implementation for Apple Silicon GPUs on PyTorch with automatic kernel compilation at runtime                                                                   |
...
* [PlayCanvas Engine](https://github.com/playcanvas/engine) ⭐ 16,823 | 🐛 487 | 🌐 JavaScript | 📅 2026-09-18
* [Unity Plugin](https://github.com/aras-p/UnityGaussianSplatting) ⭐ 3,411 | 🐛 43 | 🌐 C# | 📅 2025-10-17
* [Unreal Plugin (XScene-UEPlugin)](https://github.com/xverse-engine/XScene-UEPlugin) ⭐ 1,125 | 🐛 101 | 🌐 C++ | 📅 2025-07-30
* [Godot Plugin (gdgs)](https://github.com/ReconWorldLab/godot-gaussian-splatting) ⭐ 283 | 🐛 2 | 🌐 GDScript | 📅 2026-08-25 - Real-time 3DGS rendering plugin for Godot 4.3+
* [Unity Plugin (gsplat-unity)](https://github.com/wuyize25/gsplat-unity) ⭐ 276 | 🐛 15 | 🌐 C# | 📅 2026-08-02
...
* [GaussianSplats3D](https://github.com/mkkellogg/GaussianSplats3D) ⭐ 2,894 | 🐛 97 | 🌐 JavaScript | 📅 2025-10-19
* [gsplat.js](https://github.com/huggingface/gsplat.js) ⭐ 1,665 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-17
* [Gauzilla](https://github.com/BladeTransformerLLC/gauzilla) ⭐ 642 | 🐛 0 | 🌐 JavaScript | 📅 2025-05-23
...
* [PlayCanvas Model Viewer](https://github.com/playcanvas/model-viewer) ⭐ 708 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-13 - Viewer for glTF and 3DGS assets
* [EPFL Viewer](https://github.com/cvlab-epfl/gaussian-splatting-web) ⭐ 669 | 🐛 12 | 🌐 TypeScript | 📅 2024-03-13
* [SuperSplat Viewer](https://github.com/playcanvas/supersplat-viewer) ⭐ 568 | 🐛 33 | 🌐 TypeScript | 📅 2026-09-16 - High-performance splat viewer
* [WebGPU Splat](https://github.com/KeKsBoTer/web-splat) ⭐ 301 | 🐛 14 | 🌐 Rust | 📅 2026-03-31
* [gaussian-splatting-webgpu](https://github.com/MarcusAndreasSvensson/gaussian-splatting-webgpu) ⭐ 92 | 🐛 7 | 🌐 TypeScript | 📅 2024-06-25

### Desktop Viewers

* [Nerfstudio Viser](https://github.com/viser-project/viser) ⭐ 2,785 | 🐛 111 | 🌐 Python | 📅 2026-09-15
...
* [Blender Add-on (KIRI)](https://github.com/Kiri-Innovation/3dgs-render-blender-addon) ⭐ 1,203 | 🐛 10 | 🌐 Python | 📅 2026-08-30
* [Blender Add-on](https://github.com/ReshotAI/gaussian-splatting-blender-addon) ⭐ 589 | 🐛 31 | 🌐 Python | 📅 2024-08-30
...
* [SplatTransform](https://github.com/playcanvas/splat-transform) ⭐ 1,325 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-15 - CLI tool and Node/browser library for converting and editing splats, reads PLY, SOG, SPZ, SPLAT, KSPLAT and LCC/LCC2, writes PLY, SOG, SPZ, GLB, CSV, LOD and WebP
...
* [splatreg](https://github.com/Archerkattri/splatreg) ⭐ 16 | 🐛 0 | 🌐 Python | 📅 2026-09-18 - pip-installable splat registration: align & merge two 3DGS scans into one SE(3)/Sim(3) frame (recovers scale), CLI + pure-PyTorch API, no manual gizmo
* [AURA](https://github.com/Archerkattri/aura) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-09-18 - Calibrated per-splat confidence for 3DGS assets: held-out reliability labels, isotonic calibration, and a distribution-free conformal pruning certificate with a certified LOD ladder; exports via glTF/OpenUSD/SPZ (pip install aura-splat)
...
* [SuperSplat](https://github.com/playcanvas/supersplat) ⭐ 10,205 | 🐛 112 | 🌐 TypeScript | 📅 2026-09-16 - Free, open source browser-based 3DGS editor with one-click publishing
...
* [Discussion about gs universal format](https://github.com/mkkellogg/GaussianSplats3D/issues/47#issuecomment-1801360116) ⭐ 2,894 | 🐛 97 | 🌐 JavaScript | 📅 2025-10-19
...
* [LichtFeld Studio](https://www.youtube.com/@LichtFeldStudio) - Tutorials, release walkthroughs and dev updates for [LichtFeld Studio](https://github.com/MrNeRF/LichtFeld-Studio) ⭐ 3,711 | 🐛 222 | 🌐 C++ | 📅 2026-09-18
