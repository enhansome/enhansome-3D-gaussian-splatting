...
* [Original Gaussian Splatting](https://github.com/graphdeco-inria/gaussian-splatting) ⭐ 23,897 | 🐛 714 | 🌐 Python | 📅 2025-10-17 - The reference implementation by the original authors

### Community Implementations

| Implementation                                                                                                                                        | Language       | License    | Description                                                                                                                                                                 |
| ----------------------------------------------------------------------------------------------------------------------------------------------------- | -------------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [LichtFeld Studio](https://github.com/MrNeRF/LichtFeld-Studio) ⭐ 3,701 \| 🐛 214 \| 🌐 C++ \| 📅 2026-09-16 ([lichtfeld.io](https://lichtfeld.io))    | C++/CUDA       | GPL-3.0    | The modular workstation for 3D Gaussian Splatting — train, inspect, edit, automate, and export from a single native app                                                     |
| [Nerfstudio gsplat](https://github.com/nerfstudio-project/gsplat) ⭐ 5,694 \| 🐛 368 \| 🌐 Python \| 📅 2026-09-03                                     | Python/CUDA    | Apache-2.0 | Integration with Nerfstudio                                                                                                                                                 |
...
| [MetalSplat](https://github.com/tchauffi/metalsplat) ⭐ 7 \| 🐛 3 \| 🌐 Python \| 📅 2026-09-14                                                        | PyTorch/Metal  | MIT        | Metal-based implementation for Apple Silicon GPUs on PyTorch with automatic kernel compilation at runtime                                                                   |
...
* [PlayCanvas Engine](https://github.com/playcanvas/engine) ⭐ 16,854 | 🐛 494 | 🌐 JavaScript | 📅 2026-09-17
...
* [gsplat.js](https://github.com/huggingface/gsplat.js) ⭐ 1,664 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-17
* [Gauzilla](https://github.com/BladeTransformerLLC/gauzilla) ⭐ 641 | 🐛 0 | 🌐 JavaScript | 📅 2025-05-23
...
* [Nerfstudio Viser](https://github.com/viser-project/viser) ⭐ 2,783 | 🐛 111 | 🌐 Python | 📅 2026-09-15
...
* [Blender Add-on (KIRI)](https://github.com/Kiri-Innovation/3dgs-render-blender-addon) ⭐ 1,201 | 🐛 10 | 🌐 Python | 📅 2026-08-30
...
* [SplatTransform](https://github.com/playcanvas/splat-transform) ⭐ 1,326 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-15 - CLI tool and Node/browser library for converting and editing splats, reads PLY, SOG, SPZ, SPLAT, KSPLAT and LCC/LCC2, writes PLY, SOG, SPZ, GLB, CSV, LOD and WebP
...
* [SuperSplat](https://github.com/playcanvas/supersplat) ⭐ 10,198 | 🐛 112 | 🌐 TypeScript | 📅 2026-09-16 - Free, open source browser-based 3DGS editor with one-click publishing
...
* [LichtFeld Studio](https://www.youtube.com/@LichtFeldStudio) - Tutorials, release walkthroughs and dev updates for [LichtFeld Studio](https://github.com/MrNeRF/LichtFeld-Studio) ⭐ 3,701 | 🐛 214 | 🌐 C++ | 📅 2026-09-16
