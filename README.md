...
* [Original Gaussian Splatting](https://github.com/graphdeco-inria/gaussian-splatting) ⭐ 23,789 | 🐛 713 | 🌐 Python | 📅 2025-10-17 - The reference implementation by the original authors

### Community Implementations

| Implementation                                                                                                                                        | Language       | License    | Description                                                                                                                                                                 |
| ----------------------------------------------------------------------------------------------------------------------------------------------------- | -------------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [LichtFeld Studio](https://github.com/MrNeRF/LichtFeld-Studio) ⭐ 3,676 \| 🐛 214 \| 🌐 C++ \| 📅 2026-09-10 ([lichtfeld.io](https://lichtfeld.io))    | C++/CUDA       | GPL-3.0    | The modular workstation for 3D Gaussian Splatting — train, inspect, edit, automate, and export from a single native app                                                     |
| [Nerfstudio gsplat](https://github.com/nerfstudio-project/gsplat) ⭐ 5,661 \| 🐛 363 \| 🌐 Python \| 📅 2026-09-03                                     | Python/CUDA    | Apache-2.0 | Integration with Nerfstudio                                                                                                                                                 |
| [OpenSplat](https://github.com/pierotofy/OpenSplat) ⭐ 2,179 \| 🐛 16 \| 🌐 C++ \| 📅 2026-09-03                                                       | C++/CPU/GPU    | AGPL-3.0   | Cross-platform solution                                                                                                                                                     |
...
| [3d-gaussian-splatting](https://github.com/WangFeng18/3d-gaussian-splatting) ⭐ 371 \| 🐛 6 \| 🌐 Python \| 📅 2024-10-25                              | Python/CUDA    | MIT        | Compact reimplementation                                                                                                                                                    |
...
| [3D-Gaussian-Splatting-Reconstruction](https://github.com/Chi-Blaze-B/3D-Gaussian-Splatting-Reconstruction) ⭐ 1 \| 🐛 0 \| 🌐 Python \| 📅 2026-09-10 | Python         | Apache-2.0 | Pure PyTorch implementation from video input — no CUDA compilation required, supports CPU/NVIDIA GPU backends, built-in pose estimator & GUI                                |
...
* [DriveStudio](https://github.com/ziyc/drivestudio) ⭐ 1,259 | 🐛 55 | 🌐 Python | 📅 2025-08-27 - Urban scene reconstruction framework
...
* [PlayCanvas Engine](https://github.com/playcanvas/engine) ⭐ 16,694 | 🐛 498 | 🌐 JavaScript | 📅 2026-09-10
* [Unity Plugin](https://github.com/aras-p/UnityGaussianSplatting) ⭐ 3,400 | 🐛 43 | 🌐 C# | 📅 2025-10-17
* [Unreal Plugin (XScene-UEPlugin)](https://github.com/xverse-engine/XScene-UEPlugin) ⭐ 1,123 | 🐛 101 | 🌐 C++ | 📅 2025-07-30
* [Godot Plugin (gdgs)](https://github.com/ReconWorldLab/godot-gaussian-splatting) ⭐ 278 | 🐛 2 | 🌐 GDScript | 📅 2026-08-25 - Real-time 3DGS rendering plugin for Godot 4.3+
* [Unity Plugin (gsplat-unity)](https://github.com/wuyize25/gsplat-unity) ⭐ 274 | 🐛 14 | 🌐 C# | 📅 2026-08-02
* [Unreal Plugin (MLSLabsGaussianSplattingRenderer-UE)](https://github.com/mlslabs/MLSLabsGaussianSplattingRenderer-UE) ⭐ 268 | 🐛 4 | 🌐 C++ | 📅 2026-09-08
...
* [GaussianSplats3D](https://github.com/mkkellogg/GaussianSplats3D) ⭐ 2,888 | 🐛 97 | 🌐 JavaScript | 📅 2025-10-19
* [gsplat.js](https://github.com/huggingface/gsplat.js) ⭐ 1,664 | 🐛 42 | 🌐 TypeScript | 📅 2026-05-26
* [Gauzilla](https://github.com/BladeTransformerLLC/gauzilla) ⭐ 639 | 🐛 0 | 🌐 JavaScript | 📅 2025-05-23
...
* [SuperSplat Viewer](https://github.com/playcanvas/supersplat-viewer) ⭐ 558 | 🐛 33 | 🌐 TypeScript | 📅 2026-09-09 - High-performance splat viewer
...
* [Nerfstudio Viser](https://github.com/viser-project/viser) ⭐ 2,770 | 🐛 111 | 🌐 Python | 📅 2026-09-10
...
* [Blender Add-on (KIRI)](https://github.com/Kiri-Innovation/3dgs-render-blender-addon) ⭐ 1,192 | 🐛 10 | 🌐 Python | 📅 2026-08-30
...
* [ROS2 Support](https://github.com/shadygm/ROSplat) ⭐ 260 | 🐛 1 | 🌐 Python | 📅 2026-09-10
...
* [SplatTransform](https://github.com/playcanvas/splat-transform) ⭐ 1,315 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-09 - CLI tool and Node/browser library for converting and editing splats, reads PLY, SOG, SPZ, SPLAT, KSPLAT and LCC/LCC2, writes PLY, SOG, SPZ, GLB, CSV, LOD and WebP
...
* [gsbox Converter](https://github.com/gotoeasy/gsbox) ⭐ 194 | 🐛 3 | 🌐 Go | 📅 2026-06-18 - PLY SPLAT SPZ SPX conversion tool
...
* [SuperSplat](https://github.com/playcanvas/supersplat) ⭐ 10,001 | 🐛 111 | 🌐 TypeScript | 📅 2026-09-10 - Free, open source browser-based 3DGS editor with one-click publishing
* [GSOPs for Houdini](https://github.com/cgnomads/GSOPs) ⭐ 623 | 🐛 0 | 🌐 Python | 📅 2026-08-14 - Houdini integration tools
...
* [Discussion about gs universal format](https://github.com/mkkellogg/GaussianSplats3D/issues/47#issuecomment-1801360116) ⭐ 2,888 | 🐛 97 | 🌐 JavaScript | 📅 2025-10-19
...
* [LichtFeld Studio](https://www.youtube.com/@LichtFeldStudio) - Tutorials, release walkthroughs and dev updates for [LichtFeld Studio](https://github.com/MrNeRF/LichtFeld-Studio) ⭐ 3,676 | 🐛 214 | 🌐 C++ | 📅 2026-09-10
